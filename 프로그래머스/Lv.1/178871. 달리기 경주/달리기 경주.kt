class Solution {
    fun solution(players: Array<String>, callings: Array<String>): Array<String> {
        ...
        callings.forEach {
            ...
            val tmp = rankToPlayer[preRank]!!  // 해당 랭크로 이전 플레이어를 찾아
            rankToPlayer[preRank] = it   //  이전 플레이어 랭크에 지금 애를 넣고
            rankToPlayer[rank] = tmp    // 해당 랭크에 이전 애를 넣어
        ...
        return rankToPlayer.values.toTypedArray()
    }
}
